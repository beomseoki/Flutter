...
class StarbucksFirstPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          /// Tip : Sliver 위젯들을 이용하려면 CustomScrollView를 사용해야 편하다 !
          CustomScrollView(
            slivers: [
              ...
              /// Tip : CustomScrollView 안에서는 모든 첫 번째 위젯이 Sliver로 구현되어야 한다!
              /// SliverToBoxAdapter는 Container 같은 위젯으로 생각하자!
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 150, // 높이를 가져야 ListView를 Column 안에 넣을 수 있다.
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          /// Card
          Expanded(
            // Tip : 스크롤하는데 스냅이 걸려서 해당 항목이 화면 중앙에 보이는 경우 PageView 위젯을 사용한다.
